...
div
	...
	div(v-else id="picker_pointer_container")
		picker-points(v-for="(h,i) in TWELVE_HOURS" ':index'="interval=='AM'?i:i+12" ':key'="interval=='AM'?i:i+12" :interval="interval" ':angle'="30*i" ':handle-time-change'="handleTimePointerClick" ':picked'="interval=='AM'?i==hour:(i+12)==hour")
...
import TIME_ARRAY from '../constValues.js'
...
export default {
  ...
  data() {
    return {
      ...
      TWELVE_HOURS : TIME_ARRAY.TWELVE_HOURS,

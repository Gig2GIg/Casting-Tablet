  ...
  <section class=" bg-gray-100 flex flex-col items-center h-full w-4/12 -mt-16">
    ...
    <transition name="fade">
      <div v-if="info">
        ...
        <div class="container flex w-full mt-3">
          <div class="w-full text-center ">
            <h1 class="font-bold text-m text-left ml-20 tracking-wide purple-light">
              {{ audition.apointment.slots.length }} Apointments
            </h1>
          </div>
        </div>

        <div class="w-11/12 border border-gray-300 mt-3" />
        ...
        <div class="container flex w-full mt-3">
          <div class="flex w-full text-center justify-center flex-wrap">
            <div class="m-3 content-center rounded-full purple-back w-24 h-10 flex items-center">
              <p class="text-white text-xs font-bold content-center tracking-tighter flex-1">
                UNION
              </p>
            </div>
            ...
            <div
              ...
              :key="data.id"
              class="m-3 content-center rounded-full red-light w-24 h-10 flex items-center"
            >
              <p class="text-white text-xs font-bold content-center tracking-tighter flex-1">
                {{ data.toUpperCase() }}
              </p>
        ...
        <div class="container flex w-full mt-3 justify-center flex-wrap">
          <a
            class="text-purple font-bold text-xs"
            :href="audition.url"
            target="_blank"
          >{{ audition.url }}</a>
        </div>
          ...
          <div class="container flex w-full mt-3">
            <div class="flex w-full text-center justify-center flex-wrap">
              <div
                ...
                :key="data.id"
                class="flex m-3 content-center rounded-lg w-64 h-16 flex justify-center"
              >
      ...
      <div v-if="manage">
        ...
        <router-link :to="{ name: 'auditions/checkin', params: {id: roundActive.id } }">
          <div class="flex w-full content-center text-center justify-center flex-wrap">
            <button
              disabled
              class="m-3 content-center flex items-center flex m-3 content-center border-2 rounded-sm border-gray-600 w-48 h-10"
            >
              <p class="flex-1 text-gray-600 text-sm font-semibold content-center tracking-tighter flex-1">
                Enter Check-In Mode
              </p>
            </button>
          </div>

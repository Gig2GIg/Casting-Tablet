...
<template>
  <div class="relative rounded-lg shadow flex items-center mx-3 my-1 overflow-hidden">
    <div class="selbutton flex flex-col flex-none items-center justify-center text-white h-16 w-16">
      <svg id="noun_File_1126699" xmlns="http://www.w3.org/2000/svg" width="18.873" height="24.577" viewBox="0 0 18.873 24.577">
        <path id="Path_12" data-name="Path 12" d="M54.537,24.4a12.939,12.939,0,0,0-1.614-1.381A1.615,1.615,0,0,0,52.4,22.9h0v3.494h3.751a.821.821,0,0,0-.131-.487C55.845,25.7,55.453,25.3,54.537,24.4Z" transform="translate(-39.142 -21.113)" fill="none"/>
        <g id="Group_20" data-name="Group 20" transform="translate(0 0)">
          <path id="Path_13" data-name="Path 13" d="M54.537,24.4a12.939,12.939,0,0,0-1.614-1.381A1.615,1.615,0,0,0,52.4,22.9h0v2.6a.937.937,0,0,0,.959.894h2.791a.821.821,0,0,0-.131-.487C55.845,25.7,55.453,25.3,54.537,24.4Z" transform="translate(-39.142 -21.113)" fill="none"/>
          <path id="Path_14" data-name="Path 14" d="M40.9,24.512a3.727,3.727,0,0,0-.349-1.991,8.406,8.406,0,0,0-1.832-1.991,8.894,8.894,0,0,0-2.137-1.706,5.115,5.115,0,0,0-2.137-.325H28.685c-1.4,0-2.486,0-3.358.081a3.656,3.656,0,0,0-2.224.812,3.151,3.151,0,0,0-.872,2.072c-.087.812-.087,1.828-.087,3.128v.366h1.875v-.366a26.07,26.07,0,0,1,.087-2.925,1.824,1.824,0,0,1,.349-1.056,2.148,2.148,0,0,1,1.134-.325c.7-.081,1.744-.081,3.14-.081h3.751a.937.937,0,0,1,.959.894V23.74a1.8,1.8,0,0,0,1.875,1.747h2.835a.937.937,0,0,1,.959.894V36.9a26.07,26.07,0,0,1-.087,2.925,1.825,1.825,0,0,1-.349,1.056,2.148,2.148,0,0,1-1.134.325c-.7.081-1.7.081-3.1.081H28.685c-1.4,0-2.442,0-3.14-.081a2.148,2.148,0,0,1-1.134-.325,1.825,1.825,0,0,1-.349-1.056,26.07,26.07,0,0,1-.087-2.925V30.078H22.1v6.865c0,1.3,0,2.316.087,3.128a3.151,3.151,0,0,0,.872,2.072,3.656,3.656,0,0,0,2.224.812q1.308.122,3.4.122h5.669c1.4,0,2.486,0,3.358-.081a3.656,3.656,0,0,0,2.224-.812,3.151,3.151,0,0,0,.872-2.072c.087-.812.087-1.828.087-3.128V24.837A.42.42,0,0,0,40.9,24.512Zm-4.666-.691a.937.937,0,0,1-.959-.894v-2.6h0a.983.983,0,0,1,.523.122,8.218,8.218,0,0,1,1.614,1.381,9.38,9.38,0,0,1,1.483,1.544,1.343,1.343,0,0,1,.131.487H36.23Z" transform="translate(-22.056 -18.5)" fill="#fff"/>
          <path id="Path_15" data-name="Path 15" d="M23.919,44.494a.962.962,0,0,0-1.919,0v2.275h1.875V44.494Z" transform="translate(-22 -33.404)" fill="#fff"/>
          <path id="Path_16" data-name="Path 16" d="M22.2,31.975a.962.962,0,0,0,1.919,0V29.7H22.244v2.275Z" transform="translate(-22.113 -25.15)" fill="#fff"/>
        </g>
      </svg>

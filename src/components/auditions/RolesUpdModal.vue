<template>
    ...
    <div class="flex flex-col items-center">
      ...
      >
        <path
          id="Path_45"
          data-name="Path 45"
          d="M29.117,11.04a1.63,1.63,0,0,0-1.248.789l-4.3,7.358H9.028A4.914,4.914,0,0,0,4.14,24.076V61.554a4.914,4.914,0,0,0,4.888,4.888H59.542a1.63,1.63,0,1,0,0-3.259H9.028A1.591,1.591,0,0,1,7.4,61.554V24.076a1.591,1.591,0,0,1,1.629-1.629h15.48a1.63,1.63,0,0,0,1.4-.815L30.186,14.3h19.5L53.177,21.5a1.63,1.63,0,0,0,1.477.942H70.948a1.591,1.591,0,0,1,1.629,1.629V61.554a1.591,1.591,0,0,1-1.629,1.629,1.63,1.63,0,1,0,0,3.259,4.914,4.914,0,0,0,4.888-4.889V24.076a4.914,4.914,0,0,0-4.888-4.888H55.7l-3.514-7.231a1.63,1.63,0,0,0-1.477-.917H29.27Q29.193,11.037,29.117,11.04ZM39.988,28.15A14.665,14.665,0,1,0,54.654,42.815,14.69,14.69,0,0,0,39.988,28.15Zm0,3.259A11.406,11.406,0,1,1,28.582,42.815,11.382,11.382,0,0,1,39.988,31.409Z"
          transform="translate(-3.89 -10.788)"
          fill="#4d2545"
          stroke="#4d2545"
          stroke-width="0.5"
        />
  ...
  <div
    v-else
    class="modal-container flex flex-col items-center bg-white w-2/6 rounded-large left-1/2 absolute top-1/2 shadow-2xl overflow-hidden max-h-full py-5 px-10"
  >
    <svg
      class="absolute left-0 ml-5 cursor-pointer"
      xmlns="http://www.w3.org/2000/svg"

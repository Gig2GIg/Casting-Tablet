              ...
              >
                ...
                >
                  <div class="btn-card-wrap">
                    ...
                    />
                    <div
                      v-if="auditionData && auditionData.online == 0 && (currentAudition.user_id == userId || currentAudition.admin_id == userId) && currentAudition && currentAudition.status == 1 && round && round.status == 1"
                      class="custom-btn-grp"
                    >
                      <div
                        @click="approveBtn(data.user_id, data.is_feedback_sent, $event)"
                ...
                <!-- <div v-if="auditionData && auditionData.online == 0 && (currentAudition.user_id == userId || currentAudition.admin_id == userId) && currentAudition.status == 1 && round.status == 1" class="custom-btn-grp">
